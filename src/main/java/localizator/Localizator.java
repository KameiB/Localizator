...
import localizator.handlers.ModRegistry;
import localizator.proxy.CommonProxy;
...
public class Localizator {
    ...
    @SidedProxy(clientSide = "localizator.proxy.ClientProxy", serverSide = "localizator.proxy.CommonProxy")
