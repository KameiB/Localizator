...
public class RecipeLavaFishBucket extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv) {
        ...
        return ItemLavaFishBucket.getItemStack(BetterFishUtil.getFishId(itemFish));
    }
            ...
            if(itemStack.isEmpty()) {
                ...
                if(itemStack.getItem() == Items.LAVA_BUCKET) {
                    ...
                    if(BetterFishUtil.isBetterFish(itemStack) 
                        ...
                        && CustomConfigurationHandler.fishDataMap.get(BetterFishUtil.getFishId(itemStack)).liquid.equals(FishData.FishingLiquid.LAVA)) {
                            fishSlot = i;
                    }
                    else {
                        return null;
