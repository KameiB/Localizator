...
public abstract class ItemBoundAxeMixin {   
    ...
    private Object localizator_ForgottenItems_ItemBoundAxe_addInformation_boundTo(Object original) {
    ...
    private String localizator_ForgottenItems_ItemBoundAxe_addInformation_unbound(String original) {
    ...
    private String localizator_ForgottenItems_ItemBoundAxe_addInformation_description(String original) {
