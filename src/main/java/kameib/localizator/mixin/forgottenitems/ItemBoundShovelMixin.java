...
public abstract class ItemBoundShovelMixin {
    ...
    private Object localizator_ForgottenItems_ItemBoundShovel_addInformation_boundTo(Object original) {
    ...
    private String localizator_ForgottenItems_ItemBoundShovel_addInformation_unbound(String original) {
    ...
    private String localizator_ForgottenItems_ItemBoundShovel_addInformation_description(String original) {
