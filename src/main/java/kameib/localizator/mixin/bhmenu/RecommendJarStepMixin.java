...
public abstract class RecommendJarStepMixin {
    ...
    private String localizator_BHMenu_RecommendJarStep_init_newPressableButton_Select(String buttonText) {
    ...
    private String localizator_BHMenu_RecommendJarStep_init_newPressableButton_Change(String buttonText) {
